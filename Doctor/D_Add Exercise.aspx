<%@ page title="" language="C#" masterpagefile="~/Doctor/DoctorMaster.master" autoeventwireup="true" inherits="Doctor_D_Add_Exercise, App_Web_g3fevbmj" %>
...
<th colspan ="2" style="font-family: 'Agency FB'; font-size: small" class="style8" 
    ...
    <asp:Label ID="Lblheadr" runat="server" 
        Text="Add Exercise Here ....." ForeColor="Gray" 
...
<tr>
<td class="style4">
<asp:Label ID="Lblnm" runat="server" Text="Image Of Exercise :" ForeColor="#CC0000" 
