<%@ page language="C#" masterpagefile="~/Patient/PatientSide.master" autoeventwireup="true" inherits="Default2, App_Web_qwoa1mme" %>
...
&nbsp; <asp:Label ID="Label4" runat="server" Text="Label" style="color: #CC0000; font-family: 'Times New Roman', Times, serif; font-size: small; font-style: italic;" 
...
<td align ="right">
    <input id="btnDirections" type="button" value="Get Direction"
        onclick="return btnDirections_onclick()" onclick="return btnDirections_onclick()" /></td>
</tr>
</table>
</td>
</tr>
