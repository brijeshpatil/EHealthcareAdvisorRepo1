<%@ page title="" language="C#" masterpagefile="~/Patient/PatientSide.master" autoeventwireup="true" inherits="Patient_Patient_Exercise, App_Web_qwoa1mme" %>
 ...
 <asp:DataList ID="DataList1" runat="server" CellPadding="15" CellSpacing="5" 
        ...
        <ItemTemplate>
            <asp:ImageButton ID="ImageButton1" runat="server" Height="172px" 
                ImageUrl='<%# Eval("e_Image") %>' Width="163px" />
            ...
            <td>
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <td > <asp:Image ID="Image1" runat="server"  ImageUrl='<%# Eval("e_Image") %>' Height="230px" Width ="200px"/></td>
 <td>
 </td>
 <td>
 </td><td>
...
<td>
 ...
 <asp:Label ID="Label1" runat="server" Text='<%# Eval("e_Mored") %>' Font-Bold="True" Font-Italic="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="#006666"></asp:Label>
    </asp:Panel>
 ...
 <Resize Duration="0" Height="60px" Width="150px" />
...
<Parallel>
 ...
 <Scale ScaleFactor="5" Center="True" />
               ...
               &nbsp;&nbsp;&nbsp;
                <br />
            <br />
            <asp:Label ID="Label2" runat="server" Text='<%# Eval("e_Description") %>' 
