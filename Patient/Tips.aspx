<%@ page title="" language="C#" masterpagefile="~/Patient/PatientSide.master" autoeventwireup="true" inherits="tips, App_Web_qwoa1mme" %>
    ...
    <asp:DataList ID="DataList1" runat="server" CellPadding="15" CellSpacing="5" 
        ...
        <ItemTemplate>
            <asp:ImageButton ID="ImageButton1" runat="server" Height="172px" 
                ImageUrl='<%# bind("t_Image") %>' Width="163px" />
            ...
            <td>
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <td > <asp:Image ID="Image1" runat="server"  ImageUrl='<%# bind("t_Image") %>' Height="230px" Width ="200px"/></td>
 <td>
 </td>
 <td>
 </td><td>
...
<td>
 ...
 <asp:Label ID="Label1" runat="server" Text='<%# bind("t_mored") %>' Font-Bold="True" Font-Italic="True" Font-Names="Times New Roman" Font-Size="Large" ForeColor="#006666"></asp:Label>
    </asp:Panel>
...
<Parallel>
 ...
 <Scale ScaleFactor="5" Center="True" />
               ...
               &nbsp;&nbsp;&nbsp;
                <br />
            <br />
            <asp:Label ID="Label2" runat="server" Text='<%# bind("t_description") %>' 
