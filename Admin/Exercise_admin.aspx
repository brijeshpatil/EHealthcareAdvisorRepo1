<%@ page title="" language="C#" masterpagefile="~/Admin/AdminMaster.master" autoeventwireup="true" inherits="Admin_Exercise_admin, App_Web_3my4bwvi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:GridView ID="GridView1"  runat="server" AutoGenerateColumns="False" 
           ...
           HorizontalAlign="Center" PageSize="2" Width="925px" AllowSorting="True"   
           DataKeyNames="e_ID" onpageindexchanging="GridView1_PageIndexChanging">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Image">
                     <EditItemTemplate>
                         <asp:Image ID="Image10" runat="server" Height="172px" Width="163px" ImageUrl='<%# bind("e_Image") %>' />
                         <br />
                         <br />
                ...
                ImageUrl='<%# bind("e_Image") %>'  />
                            </ItemTemplate>
                
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Description">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# bind("e_Description") %>'></asp:TextBox>
                    </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# bind("e_Description") %>'></asp:Label>
                </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="More..">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine" Text='<%# bind("e_Mored") %>'></asp:TextBox>
                    </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# bind("e_Mored") %>'></asp:Label>
                </ItemTemplate>
                </asp:TemplateField>
            </Columns>
       ...
       <asp:Button ID="Button1" runat="server" BackColor="White" Font-Bold="True" 
           ...
           Text="Add Tips ...."  ForeColor="#336666" />
