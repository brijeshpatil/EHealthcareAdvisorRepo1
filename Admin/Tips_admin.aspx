<%@ page title="" language="C#" masterpagefile="~/Admin/AdminMaster.master" autoeventwireup="true" inherits="Admin_Tips_admin, App_Web_3my4bwvi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:GridView ID="GridView1"  runat="server" AutoGenerateColumns="False" 
           ...
           HorizontalAlign="Center" PageSize="2" Width="924px" AllowSorting="True"   
           DataKeyNames="t_ID" onpageindexchanging="GridView1_PageIndexChanging">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Image">
                     <EditItemTemplate>
                         <asp:Image ID="Image10" runat="server" Height="172px" Width="163px" ImageUrl='<%# bind("t_Image") %>' />
                         <br />
                         <br />
                ...
                ImageUrl='<%# bind("t_Image") %>'  />
                            </ItemTemplate>
                
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Description">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# bind("t_description") %>'></asp:TextBox>
                    </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# bind("t_description") %>'></asp:Label>
                </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="More..">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine" Text='<%# bind("t_mored") %>'></asp:TextBox>
                    </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# bind("t_mored") %>'></asp:Label>
                </ItemTemplate>
                </asp:TemplateField>
            </Columns>
